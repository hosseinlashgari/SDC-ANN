...
class InceptionAux(nn.Module):
    def __init__(
        ...
        if conv_block is None:
            conv_block = BasicConv2d
        self.avgpool0 = nn.AvgPool2d(kernel_size=5, stride=3)
...
def m_inception_v3(*, weights: Optional[Inception_V3_Weights] = None, progress: bool = True, **kwargs: Any) -> Inception3:
    """
